          ...
          <div className='flex flex-col lg:grid lg:grid-cols-12 lg:gap-20'>
              ...
              <section>
                <form action=''>
                  ...
                  <div className='flex flex-col lg:flex-row justify-between mb-4'>
                    ...
                    <div className='flex relative'>
                      <input name='cvv_no' id='cvv_no' className='flex p-4 text-blue-950 w-full lg:w-[21rem] font-semibold lg:pl-[9.5rem] rounded-lg border-2 border-gray-200 outline-blue-600 focus:bg-gray-100 placeholder-blue-950' type='text' placeholder='327' required maxLength={3} />
                  ...
                  <div className='flex flex-col lg:flex-row justify-between mb-4'>
                    ...
                    <div className='flex w-[21rem] space-x-1'>
                      <div className=''>
                        <input name='expiry_date' id='expiry_date' className='flex-1 lg:pl-14 font-semibold py-6 lg:px-5 px-8 text-blue-950 h-8 rounded-lg border-2 border-gray-200 outline-blue-600 focus:bg-gray-100 placeholder-blue-950' type='number' placeholder='09' required min={1} max={12} />
                      </div>
                      <span className='flex items-center px-3.5 text-blue-950'>/</span>
                      <div className=''>
                        <input name='expiry_date' id='expiry_date' className='flex-1 lg:pl-16 font-semibold py-6 lg:px-3.5 px-10 text-blue-950 h-8 rounded-lg border-2 border-gray-200 outline-blue-600 focus:bg-gray-100 placeholder-blue-950' type='number' placeholder='22' required min={1} max={31} />
                      </div>
                    </div>
                  </div>
                  ...
                  <button className='w-6/12 lg:w-full bg-blue-600 absolute lg:static bottom-0 py-6 lg:px-36 translate-x-1/2 lg:translate-x-0 rounded-lg text-white font-semibold transition ease-in-out delay-250 hover:bg-blue-800'>Pay Now</button>
                </form>
              </section>
            </div>
            ...
            <div className='lg:col-span-4'>
              <div className='mb-52 lg:mb-0'>
                <span className='absolute right-40 lg:right-48 lg:top-[4.7rem] top-[44.6rem]  h-6 w-[3.9rem] block bg-blue-600 rounded-sm transform translate-x-1/2'></span>
